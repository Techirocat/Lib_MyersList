...
Os gráficos das Tabelas \ref{tab:travessias_1} e \ref{tab:travessias_2} comparam o número de travessias do pior caso com o limite 
...
\begin{table}[h!]
    \centering
    \begin{tabular}{cc}
        \textbf{Variante} & \textbf{Lookup All 1\_000\_000 (ms)} \\
        \hline
         Basic Myers List & 57,42\\
         \hline
         Improved Myers List & 77,46\\
         \hline
         Advanced Myers List & 401,43\\
         \hline
...
cada célula ter de guardar explicitamente a informação de RHD e RED necessária para a sua construção e para a otimização do lookup face as varaiantes anteriores. 
