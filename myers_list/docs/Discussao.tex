...
tempo constante. Esta limitação deve-se à impossibilidade de aceder a uma determinada célula, que será utilizada como ponteiro uncle,
greater ou inc. No entanto, foi possível implementar uma operação cons funcional para esta estrutura, com uma complexidade temporal de 
...
conclui-se que esta estrutura apresenta um melhor desempenho, tanto a nível de velocidade de execução como também em número de travessias 
...
Em suma, a remoção da restrição permitiu-nos implementar duas novas estruturas de dados ... (TODO)
